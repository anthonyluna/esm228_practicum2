...
*Challenge of drawing a representative sample*: Fishing vessel captains are less likely to be in port and available to answer questions than fish suppliers.

*Sampling procedure*: Stratify sampling with a more fishers than suppliers to 
